...
and use it's own if you don't create one. If you want to create your own, once you are in the camel-converter directory create and activate
...
camel-converter uses [isort](https://pycqa.github.io/isort/),
...
```sh
# Run isort
isort camel_converter tests

# Run black
black camel_converter tests

# Run flake8
flake8 camel_converter tests

# Run mypy
mypy camel_converter
```
...
tox can be used to run both linting, and run the tests in all versions of Python camel-converter supports. Note that you will need to have all the verions of Python installed for this to work.
...
If everything looks good, you are ready to make a pull request. This is how you let the maintainers of the camel-coverter project know you have code ready to be reviewed. To submit the pull request:
